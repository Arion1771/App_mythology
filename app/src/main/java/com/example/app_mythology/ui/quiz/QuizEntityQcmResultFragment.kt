...
class QuizEntityQcmResultFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val entites = viewModel.qcmEntites.value ?: emptyList()
        val index   = viewModel.qcmIndex.value ?: 0
        val entity  = entites.getOrNull(index)
        ...
        val isLast = index + 1 >= entites.size
